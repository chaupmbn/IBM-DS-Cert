...
app.layout = html.Div([
    ...
    html.H1(children='Automobile Sales Statistics Dashboard', style={
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        exp_rec = recession_data[recession_data['Recession'] == 1].groupby(
            'Vehicle_Type').sum().reset_index()
        R_chart3 = dcc.Graph(
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    ...
    elif (input_year != 'select-year' and selected_statistics == 'Yearly Statistic'):
